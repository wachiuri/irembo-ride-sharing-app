...
public class DriverWriteConverter implements Converter<Driver, OutboundRow> {
    ...
    public OutboundRow convert(Driver driver) {
        ...
        row.append("id", driver.getId() != null ? Parameter.from(driver.getId()) : Parameter.empty(Long.class))
                .append("name", Parameter.from(driver.getName() != null ? driver.getName() : ""))
                .append("email", Parameter.from(driver.getEmail() != null ? driver.getEmail() : ""))
                .append("pin", Parameter.from(driver.getPin() != null ? driver.getPin() : 0))
                .append("phoneNumber", Parameter.from(driver.getPhoneNumber() != null ? driver.getPhoneNumber() : ""))
                ...
                .append("profilePicture", Parameter.from(driver.getProfilePicture() != null ? driver.getProfilePicture() : ""))
